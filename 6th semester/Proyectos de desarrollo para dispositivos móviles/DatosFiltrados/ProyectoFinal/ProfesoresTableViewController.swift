...
class ProfesoresTableViewController: UITableViewController, UISearchResultsUpdating {
    let direccion="http://martinmolina.com.mx/202111/equipo5/data/palabras.json"
    var datos = ["Rolando Vallejo","Gil Huesca","Iván Guerrero", "David Escarcega","Andrés Torres", "Martín Molina"]
    var nuevoArray:[Any]?
